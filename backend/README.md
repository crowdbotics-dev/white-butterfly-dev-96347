...
## Project Structure
    ...
    ├── white_butterfly_dev_96347  # Django project configurations
...
1. Clone this repo and `cd white_butterfly_dev_96347`
...
2. Clone this repo and `cd white_butterfly_dev_96347`
